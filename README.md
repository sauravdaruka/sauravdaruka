...
**Messaging and Data:** Kafka, PostgreSQL, Redis, Amazon SNS, Amazon SQS  
**Cloud and Platform:** AWS, Docker, Kubernetes, LocalStack, Azure DevOps CI/CD  
...
A Java implementation of extensible claim-validation rules using interfaces, factories, domain models, and automated tests.

## Technical writing

- [Jolt Transformation Overview](https://medium.com/@sauravdaruka/https-medium-com-sauravdaruka-jolt-transformation-overview-ed769d28a3) — a practical guide to JSON-to-JSON transformation with 37K+ views.

## Connect

- [LinkedIn](https://www.linkedin.com/in/sauravdaruka/)
- [Medium](https://medium.com/@sauravdaruka)
